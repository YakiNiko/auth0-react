(function (global, factory) {
  ...
  var Ee,
    ...
    lt = at('startsWith'),
    ft = !(
      lt || ((Ee = ct(String.prototype, 'startsWith')), !Ee || Ee.writable)
    );
  tt(
  ...
  for (Sr in Zr)
    (kr = (_r = p[Sr]) && _r.prototype) ? le(kr, Lr, _r) : (Pr = !1);
  ...
  var Xr = {
    ...
    Jr = function (e) {
      return Dr(
        ((t = e),
        (n = e[zr]),
        void 0 === (o = ce(t).constructor) || null == (r = ce(o)[Yr])
          ? n
          : dt(r))
      );
      var t, n, r, o;
  ...
  exports.useRequiredAuthentication = useRequiredAuthentication;
